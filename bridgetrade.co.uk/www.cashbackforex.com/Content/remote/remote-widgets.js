...
function resizeCBFCalcWidget(data) {
    ...
    for (var i = 0; i < ifrms.length; i++) {
        ifrms[i].setAttribute("style", "width:100%; border: 0; height:" + data.targetHeight + "px;");
...
function popoutPositionCalcWidget(data) {
    ...
    popoutDiv.innerHTML = '<img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKCAYAAACNMs+9AAAAFUlEQVR42mP8z/CfiYEIwDiqkL4KAYFAFAs8gr9XAAAAAElFTkSuQmCC" style="position: absolute; top:0; left:0; background: transparent !important; border: 0px solid; box-shadow: none !important; -webkit-box-shadow: none !important; padding: 0px;" alt="' + data.title + '"><svg width="19" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">' +
